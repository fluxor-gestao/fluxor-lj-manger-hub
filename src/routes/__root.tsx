...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lundgaard Hub" },
      { name: "description", content: "Sistema de Gestão - Lundgaard Jensen" },
      { property: "og:title", content: "Lundgaard Hub" },
      { property: "og:description", content: "Sistema de Gestão - Lundgaard Jensen" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lundgaard Hub" },
      { name: "twitter:description", content: "Sistema de Gestão - Lundgaard Jensen" },
