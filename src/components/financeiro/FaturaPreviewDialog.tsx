    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto p-0">
        ...
        <div className="grid lg:grid-cols-[1.4fr_1fr] gap-0">
          ...
          <div className="p-6">
            <div className="rounded-xl border bg-white text-zinc-900 shadow-sm overflow-hidden">
              ...
              <div className="grid grid-cols-3 gap-4 p-6 border-b">
                ...
                <Tile label="Forma de pagamento" value="PIX / Boleto" />
                <Tile label="Competência" value={row.competence_month ?? "—"} />
              </div>
          ...
          <div className="border-l bg-muted/20 p-6 flex flex-col gap-4">
            <div>
