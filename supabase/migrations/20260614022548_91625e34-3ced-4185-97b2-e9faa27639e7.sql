...
BEGIN
  ...
  VALUES (_type::public.changelog_entry_type, _description, 'lovable:' || to_char(now(),'YYYYMMDDHH24MISSMS'))
  ...
  RETURN jsonb_build_object('entry_id', _entry_id, 'version_id', _new_version_id, 'new_version', _new_version);
END;
$$;
